        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td align="left" valign="middle" style="font-family:${FONTS.heading}; font-weight:700; font-size:18px; color:${THEME.textPrimary}; letter-spacing:0.04em;">
              <span style="display:inline-block; vertical-align:middle; margin-right:10px;">${logoSvg(22, "#ffffff", assetMode, "logo-header")}</span>
  ...
  return `
    <tr>
      <td bgcolor="${THEME.bgFooter}" style="background-color:${THEME.bgFooter}; padding:40px 36px 32px; border-top:1px solid ${THEME.borderSubtle};" align="center">
        <div style="margin-bottom:10px;">${logoSvg(42, "#ffffff", assetMode, "logo-footer")}</div>
...
<style>
  ...
  * { -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; }
  ...
  @media only screen and (max-width: 640px) {
    ...
    .em-stack-pad { padding-bottom: 16px !important; }
...
export function getChartSvgFull(points) {
  return buildChartSvg(points, "inline");
}
