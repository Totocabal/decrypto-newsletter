...
function EditoEditor({ data, set }) {
  ...
  return (
    <>
      ...
      <Field
        label="Corps"
        hint="HTML : <strong>, <em>, <u>, <s>, <a>, <ul><li>, <ol><li>"
      >
        <TextArea
          showCount
          rows={4}
...
function FearGreedEditor({ data, set }) {
  ...
  return (
    <>
      ...
      <Field label="Commentaire" hint="HTML : <strong>, <em>, <u>, <s>, <a>, <ul><li>, <ol><li>">
        <TextArea
          showCount
          rows={3}
...
function MacroEditor({ data, set }) {
  return (
    <>
      ...
      <Field label="Corps" hint="HTML autorisé">
        <TextArea
          showCount
          rows={3}
          value={data.body}
...
function TextBlockEditor({ data, set }) {
  return (
    <>
      ...
      <Field label="Corps" hint="HTML : <strong>, <em>, <u>, <s>, <a>, <ul><li>, <ol><li>">
        <TextArea
          showCount
          rows={5}
          value={data.body}
