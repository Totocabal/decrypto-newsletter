        ...
        <div className="w-full max-w-2xl border border-white/10 bg-[#1E1E22] rounded-sm overflow-hidden shadow-2xl">
          ...
          <div className="p-7 sm:p-9">
            ...
            <p className="text-sm sm:text-base leading-relaxed text-stone-300 max-w-xl mb-7">
              Aucun rechargement automatique n'est lancé. Tu peux tenter un
              rechargement manuel, ou ouvrir la page sans le brouillon local :
              ton brouillon est mis de côté dans le navigateur, et tu gardes ta
              session.
            </p>
