...
function normalizeSectionData(type, data = {}) {
  ...
  return {
    ...
    show_top_separator: data.show_top_separator === true,
    show_bottom_separator: data.show_bottom_separator !== false,
    bg_variant: ["auto", "light", "dark"].includes(data.bg_variant) ? data.bg_variant : defaults.bg_variant,
