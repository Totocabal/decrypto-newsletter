...
- timeline utilise exactement : - title | body obligatoire. À utiliser pour un parcours chronologique, un tutoriel ou des étapes reliées.
- Sur les blocs avec un titre éditorial (edito, text_block, fear_greed, signals, macro, focus), champ optionnel number_position: "kicker" ou "title" pour choisir où afficher la numérotation du bloc. Par défaut, utilise "kicker".
